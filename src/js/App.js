...
window.appState = new State();
    ...
    ,{"id":"baa","displayname":"Marathon"}
    ,{"id":"animebos","displayname":"Anime"}
    ,{"id":"boscalling","displayname":"Boston Calling (Fall)"}
    ,{"id":"riot","displayname":"Wine Riot"}
...
appPanels.findWhere({id:appState.get("slug")}).set({active:true})
